...
def login(email,password,proxy):
	...
	token = "09ANVZ79rYo8_zAf0i47YWHEh87XNdEJAe47qbdcrINfNwZZUP…apInbu0p3Redp8lka1g0Q3IFA2Y-QCuuYQsgfOoHPYeOvAvuw"
	...
	if login.url == LOGIN_URL:
		print ([False,"Dead",email,password])
		return False
	else:
		print ([True,"Working",email,password])
		return True
